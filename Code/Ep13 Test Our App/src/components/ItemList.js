        ...
        >
          <div className="flex  justify-between gap-6 p-4">
            ...
            <div className="w-3/12 h-32 shadow-xl rounded-lg overflow-hidden">
              <button className="rounded-tl-lg rounded-br-lg p-2 z-10 text-xs font-bold absolute  text-green-600 shadow-md bg-gray-100 hover:cursor-pointer hover:bg-green-600 hover:text-white" onClick={()=>handleAddItem(item)}>
                ADD +
              </button>
