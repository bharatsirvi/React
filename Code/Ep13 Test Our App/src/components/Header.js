...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center px-30 shadow-lg dark:bg-green">
      ...
      <div className="nav-items">
        <ul className="flex items-center">
          ...
          <li className="px-4">
            <Link
              to="/cart"
              className="m-1 ms-0 relative py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 "
            >
              <FaShoppingCart size={20} />
              {cart.length != 0 && (
                <span className="flex absolute top-0 end-0 -mt-2 -me-2">
                  <span className="animate-ping absolute inline-rflex size-full rounded-full bg-red-400 opacity-75 dark:bg-red-600"></span>
